...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, SafeAreaView, ActivityIndicator, RefreshControl, Platform, StatusBar } from 'react-native';
...
interface Notification {
  ...
  title: string;
  message: string;
  type: 'booking' | 'status' | 'system' | 'chat' | 'general' | 'lead';
  read: boolean;
  createdAt: string;
}
...
const iconForType = (type: string) => {
  switch (type) {
    ...
    case 'lead':    return { name: 'flash-outline',           color: '#F59E0B' };
    case 'status':  return { name: 'checkmark-circle-outline',color: '#10B981' };
    case 'chat':    return { name: 'chatbubbles-outline',     color: '#3B82F6' };
